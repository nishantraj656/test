...
class LogoTitle extends React.Component {
    ...
    fetch('https://3day.000webhostapp.com/run_query.php', {
        ...
        body: JSON.stringify({
            ...
            _renderIteam=({item})=>{
                ...
                var yourBase64Icon = 'data:image/png;base64,'+item.image;
                    ...
                    <View>
                        <View style={styles1.contener}>
                            ...
                            <View style={styles1.Title}>
                                <Text style={styles1.titleName}>{item.title}</Text>
                            </View>
  ...
  class DetailsScreen extends React.Component {
        ...
        fire = (id) =>{
            ...
            let sql = "select * from `gk` where id="+id;
            console.log(sql);
            fetch('https://3day.000webhostapp.com/run_query.php', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    .then((responseJson) => {
                       ...
                       // alert("changed password successfully"); 
                        ...
                        this.setState({details:responseJson[0].details});
                        this.setState({image:responseJson[0].image});
                        this.setState({date:responseJson[0].date});
